...
const recoverySignInBtn = document.getElementById("recovery-signInBtn");
...
const recoverySignInElements = document.querySelector("div[class=recovery-signInElements]");
...
const recoverySignInHitbox = document.getElementById("recovery-signInArrowHitbox");
...
// recovery sign in
recoverySignInHitbox.onmouseover = () => {
    recoverySignInElements.style.transform = "translateX(0%)"; 
    recoverySignInHitbox.style.visibility = "hidden";
}
recoverySignInElements.onmouseleave = () => {
    recoverySignInElements.style.transform = "translateX(100%)"; 
    recoverySignInHitbox.style.visibility = "visible";
}
    ...
    if (btn === "signUp") {
        ...
        await new Promise((resolve, reject) => {
            ...
            setTimeout(() => {
                // Container changes based on what page the user is currently on
                // Implement this change in the future
                recoverAccContainer.style.visibility = "hidden"; 
                //
